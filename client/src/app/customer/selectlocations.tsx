...
const LocationSelection = () => {
  ...
  const checkDistance = async () => {
    ...
    if (distance < minDistance) {
      alert(
        "Pickup and drop location cannot be less than 0.5 km please select different locations",
      );
    } else if (distance > maxDistance) {
      alert(
        "Pickup and drop location cannot be more than 50 km please select different locations",
      );
    } else {
      setLocations([]);
      router.navigate({
