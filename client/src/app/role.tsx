...
const Role = () => {
    ...
    return (
        <View style={roleStyles.container}>
            ...
            <Text className='font-JakartaMedium text-[20px] text-[#075BB5]'>Select Who you are</Text>
            ...
            <TouchableOpacity style={roleStyles.card} onPress={handleCustomerPress}>
                ...
                <View style={roleStyles.cardContent}>
                    <Text className='font-JakartaMedium text-[15px] text-[#075BB5]'>Customer</Text>
                </View>
            ...
            <TouchableOpacity style={roleStyles.card} onPress={handleCaptainPress}>
                ...
                <View style={roleStyles.cardContent}>
                    <Text className='font-JakartaMedium text-[15px] text-[#075BB5]'>Captain</Text>
                </View>
