      ...
      <StripeProvider publishableKey={process.env.EXPO_PUBLIC_STRIPE_PUBLISHABLE_KEY}>
        <WSProvider>
          <Stack>
            ...
            <Stack.Screen name="customer/complaints" options={{ headerShown: false }} />
            <Stack.Screen name="customer/liveride" options={{ headerShown: false }} />
            <Stack.Screen name="customer/myrides" options={{ headerShown: false }} />
            <Stack.Screen name="customer/payment" options={{ headerShown: false }} />
