...
const MapPickerModel: FC<MapPickerModelProps> = ({
    ...
    useEffect(() => {
        if (selectedLocation?.latitude) {
            ...
            mapRef.current?.fitToCoordinates([{ latitude: selectedLocation?.latitude, longitude: selectedLocation?.longitude }], {
                edgePadding: {
                    top: 50,
                    right: 50,
                    bottom: 50,
    ...
    return (
        ...
        >
            <View style={modalStyles.modalContainer}>
                <Text className="font-JakartaBold" style={modalStyles.centerText}>Select {title}</Text>
                <TouchableOpacity onPress={onClose}>
                    <Text className="font-JakartaBold" style={modalStyles?.cancelButton}>Cancel</Text>
                </TouchableOpacity>
                ...
                {text !== "" ? (
                    ...
                    <View style={{ flex: 1, width: "100%", height: "100%" }}>
                        ...
                        <TouchableOpacity onPress={handleGspButtonPress} style={mapStyles.gpsButton}>
                            <MaterialCommunityIcons name="crosshairs-gps" size={RFValue(24)} color="#3C75BE" />

                        </TouchableOpacity>
                    </View>
                    <View style={modalStyles.footerContainer}>
                        <Text className="font-JakartaBold" style={modalStyles.addressText} numberOfLines={2}>{address==="" ? "Getting address ..." : address}</Text>
                        ...
                        <View style={modalStyles.buttonContainer}>
                            <TouchableOpacity style={modalStyles.button} onPress={()=>{
                                ...
                                <Text className="font-JakartaBold" style={modalStyles?.buttonText}>Set Address</Text>
